...
//       const movie = `<div class='movies-container col-12 col-md-6 col-lg-4 col-xl-3'><div class='movie card'><img src="${img}"> <h2 class="card-title">${title}</h2> ${button}</div></div>`;
...
let OnLineStatus = () => {
  ...
  if (navigator.onLine) {
    this.setTimeout(() => {
      ...
      divAppStatus.innerHTML = 'Conectado'
    }, 1000);
  } else {
    ...
    divAppStatus.innerHTML = 'Sin conexion'
  }
}
